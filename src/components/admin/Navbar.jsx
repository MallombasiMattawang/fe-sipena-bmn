...
export default function navbar() {
    ...
    return (
        <nav className="sb-topnav navbar navbar-expand navbar-dark bg-dark border-top-yellow shadow-sm fixed-top" style={{ paddingLeft: 0, height: '56px', zIndex: '1039' }}>
            <a className="navbar-brand ps-3 fw-bold" href="#">
                <strong className="text-danger">SIPENA</strong> | OTBAN5
            </a>
            <button
