...
import SponsorsCreate from "./Create";

export default function SponsorIndex() {
  //title page
  document.title = "Sponsor Event";
  ...
  const fetchData = async (pageNumber = 1, keywords = "") => {
    ...
    await Api.get(`/api/admin/event-sponsors?search=${keywords}&page=${page}`, {
      //header
      headers: {
        //header Bearer + Token
      ...
      buttons: [
        {
          label: "YES",
          onClick: async () => {
            await Api.delete(`/api/admin/event-sponsors/${id}`, {
              //header
              headers: {
                //header Bearer + Token
                Authorization: `Bearer ${token}`,
          ...
          <div className="row">
            <div className="col-md-12">
              {hasAnyPermission(["sliders.create"]) && (
                <SponsorsCreate fetchData={fetchData} />
              )}
            </div>
          </div>
                    ...
                    <table className="table table-bordered table-centered mb-0 rounded">
                      <thead className="thead-dark">
                        <tr className="border-0">
                          ...
                          <th className="border-0">Sponsor Name</th>
