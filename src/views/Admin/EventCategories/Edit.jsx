...
export default function EventCategoriesEdit() {
    //title page
    document.title = "Edit Category Events";
    ...
    const fetchDataCategory = async () => {
        await Api.get(`/api/admin/event-categories/${id}`, {
            //header
            headers: {
                //header Bearer + Token
                Authorization: `Bearer ${token}`,
            ...
            setMember_limit(response.data.data.member_limit);
