...
export default function EventCategoriesIndex() {
    ...
    const fetchData = async (pageNumber = 1, keywords = "") => {
        ...
        await Api.get(`/api/admin/event-categories?search=${keywords}&page=${page}`, {
            //header
            headers: {
                //header Bearer + Token
                            ...
                            <div className="row">
                                {hasAnyPermission(["event_categories.create"]) && (
                                    <div className="col-md-3 col-12 mb-2">
                                        <Link
                                            to="/admin/event-categories/create"
                                        ...
                                        <table className="table table-bordered table-centered mb-0 rounded">
                                            <thead className="thead-dark">
                                                <tr className="border-0">
                                                    ...
                                                    <th className="border-0">Limit Member</th>
                                                    ...
                                                    categories.length > 0 ? (
                                                        ...
                                                        categories.map((category, index) => (
                                                            <tr key={index}>
                                                                ...
                                                                <td>{category.name}</td>
                                                                <td>{category.member_limit}</td>
                                                                <td>{moneyFormat(category.cost)}</td>
                                                                <td className="text-center">
                                                                    {hasAnyPermission(["event_categories.edit"]) && (
                                                                        <Link
                                                                            to={`/admin/event-categories/edit/${category.id}`}
